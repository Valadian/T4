...
class TournamentRunner extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    if (this.state && this.state.value) {
      return (
        <>
          {this.breadcrumbs()}
          <TournamentHeader tournament={this.state.value}/> {/*eventually I'd like to make an interactive variant of this and present it to the TO as a quick way of editing an event.*/}
          <div>
            {/* <div className="mb-3">
            ...
            <div className="mb-3">
              ...
              <DatePicker
                selected={this.state.value.start}
                onChange={(value) => this.setState({ value: { start: value } })}
                isClearable
                className="form-control"
            ...
            <div className="mb-3">
              <label htmlFor="gameInput" className="form-label">
                Game
              </label>
              ...
              <Select
                value={this.state.value.Game.key}
...
export default withParams(TournamentRunner);
