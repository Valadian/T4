...
import TournamentLadderProtectionEditor from "./TournamentLadderProtectionEditor";
    ...
    <div>
      ...
      <Row className="pt-3 small">
        {/* Timezone issue: day of the month off by one depending on tz; 
          need to iron out overall tz approach*/}
        <Col xs={12} md>
          <Row>
            <Col>
              ...
              {console.log(`Passing DateEditor ${JSON.stringify(props)}`)}
            ...
            <Col>
              <div className="d-grid">
                ...
                <Button
                  variant="outline-primary"
                  onClick={() => {
                    setShowTournamentRegistrationEditor(true);
                  }}
                  size="sm"
                >
                  <i className="bi bi-person-plus-fill text-primary"></i>{" "}
                  <span className="text-white">{signup_availability}</span>
                </Button>
              </div>
              <TournamentRegistrationEditor
                show={showTournamentRegistrationEditor}
                onHide={() => setShowTournamentRegistrationEditor(false)}
                tournament={props.tournament}
              />
            </Col>
          </Row>
        ...
        <Col xs={12} md={3}>
          ...
          <Row>
            <Col>
              ...
              <TournamentLadderProtectionEditor
                show={showTournamentLadderProtectionEditor}
                onHide={() => setShowTournamentLadderProtectionEditor(false)}
                tournament={props.tournament}
              />
            </Col>
          </Row>
